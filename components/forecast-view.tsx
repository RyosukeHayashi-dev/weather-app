  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-8 max-w-none w-full">
        ...
        <header className="mb-12">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-4xl xl:text-5xl font-bold text-white bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 bg-clip-text text-transparent">
                🌤️ 名古屋 5日間天気予報
              </h1>
              {isUsingMockData && (
                <p className="text-yellow-400 text-lg mt-2">※ 模擬データを表示中</p>
              )}
            </div>

            <div className="w-48"></div> {/* スペーサー */}
          </div>
        </header>
        ...
        {/* 選択された日の詳細表示 */}
        {selectedDay !== null && (
          <Card className="bg-gradient-to-br from-black/70 via-gray-900/50 to-black/70 backdrop-blur-xl border border-orange-400/40 text-white mb-8">
            <CardContent className="p-8">
